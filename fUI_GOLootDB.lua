...
--  12  Midnight
	...
	{ key = "X12:DLVArenaSpect",		text = "Arena Spectator says" },
	{ key = "X12:DLVBloodsport",		text = "Bloodsport Enthusiast says" },
...
--  03  Wrath
	{ key = "X03:SoulguardWatch",		text = "Soulguard Watchman" },
--  02  Outland
	{ key = "X02:BloodwarderFlcnr",		text = "Bloodwarder Falconer yells" },
	{ key = "X02:Ordinary",				text = "Ordinary yells" },
	{ key = "X02:DGUnderbog01",			text = "Underbog Lurker" },
	{ key = "X02:DGUnderbog02",			text = "Bog Giant" },
	{ key = "X02:DGUnderbog03",			text = "Wrathfin Warrior" },
	{ key = "X02:DGUnderbog04",			text = "Murkblood" },
	{ key = "X02:DGShatteredHand",		text = "Shattered Hand" },
	{ key = "X02:DGShadowmoonAdpt",		text = "Shadowmoon Adept" },
	{ key = "X02:DGShadowmoonChnl",		text = "Shadowmoon Channeler" },
	{ key = "X02:DGShadowmnTechn",		text = "Shadowmoon Technician" },
	{ key = "X02:PBNarrok",				text = "Narrok says" },
	{ key = "X02:EtherealCrptRadr",		text = "Ethereal Crypt Raider becomes enraged" },
--  01  Eastern Kingdoms
...
--  Addon
	...
	{ key = "VND:Running",				text = "Running auto-sell" },
	{ key = "VND:SellLimit",			text = "Reached the sell limit" },
	{ key = "VND:SoldItems",			text = " items for " },
...
--  Blizzard
	{ key = "BLZ:BuyerFound",			text = "A buyer has been found" },
