...
SetZone("Harandar, Eastern Kingdoms")
   ...
   t[136764] = { text = "<Meditate here for a moment.>" }                                              -- Toy () Altar of Wisdom (590789)
   t[136767] = { text = "<Offer the old rolled up pillow...>", close = true }                          -- Toy () Elder Spirit (254116)
...
SetZone("Silvermoon City, Eastern Kingdoms")
   ...
   local t = NPC("Riftblade Astre", { 249459, })
...
SetZone("Voidstorm, Eastern Kingdoms")
   ...
   local t = NPC("Decimus", { 235607, 235392, 235653, 243276, 248583, 244948, 252853, 243907, })
   ...
   local t = NPC("Magister Umbric", { 239828, 235698, 247668, })
   ...
   local t = NPC("Riftblade Maella", { 240538, 239349, 238531, 247595, })
   ...
   local t = NPC("Riftwalker Sideras", { 247594, })
